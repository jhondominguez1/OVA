	...
	<body>
		...
		include ("../conex/conexion.php");
			...
			while ($reg=mysqli_fetch_array($registros)){
				echo "<tr><td>".$reg['numero_identificacion']."</td><td>".$reg['nombre_usuario']."</td><td>".$reg['rol']."</td><td><a href=./eliminarusuario.php?id=".$reg['id_usuario'].">Eliminar</a></td><td><a href=./frmactualizar.php?id=".$reg['id_usuario'].">Actualizar</a></td></tr>";
			}
	    ?>
		</table>
	</body>
